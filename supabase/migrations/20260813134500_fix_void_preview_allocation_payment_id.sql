-- Fix emergency invoice-void preview to use the current allocation-to-payment key.
-- customer_payment_allocations links to customer_payments through payment_id, not central_payment_id.
