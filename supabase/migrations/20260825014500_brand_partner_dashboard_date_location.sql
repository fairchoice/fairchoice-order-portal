create or replace function public.fc_brand_partner_dashboard_v2(
  p_username text,
...
declare
  a record;
  d1 date := greatest(coalesce(p_date_from, date '2026-08-24'), date '2026-08-24');
...
revoke all on function public.fc_brand_partner_dashboard_v2(text,text,date,date,text,text,text,text,text,integer,integer,integer,integer) from public;
grant execute on function public.fc_brand_partner_dashboard_v2(text,text,date,date,text,text,text,text,text,integer,integer,integer,integer) to anon, authenticated, service_role;
